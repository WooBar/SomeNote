...
//	 *            压缩质量
//	 * @param smallIcon
//	 *            文件名的小小后缀(注意，非文件后缀名称),入压缩文件名是yasuo.jpg,则压缩后文件名是yasuo(+smallIcon).jpg
//	 * @return 返回压缩后的文件的全路径
//	 */
...
//	 */
//	public static void saveMinPhoto(MultipartFile imgFile, String deskURL, double comBase,
...
//		//ImageCompressUtil.zipImageFile("E:\\2222222.jpg", 1280, 1280, 1f, "x2");
//		//ImageCompressUtil.saveMinPhoto("E:/1111.png", "E:/4444.jpg", 750, 1);
//	}
//}
